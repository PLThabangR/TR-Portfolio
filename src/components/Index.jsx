    ...
    <div className="row gx-5 justify-content-center">
        <div className="col-xxl-8">
            <div className="text-center my-5">
                ...
                <p className="lead fw-light mb-4">My nameThabang Rakgoropo born in 17 June 1993,I am a Frontend Developer with demonstrated Programming experience I got from a internship at the Digital Academy. I help brands grow in Web development. </p>
